drop database df8v0np2fhmom9;
drop user hjnknsmimrlszw;
create user hjnknsmimrlszw with password 'password';
create database df8v0np2fhmom9 with template=template0 owner=hjnknsmimrlszw;
\connect df8v0np2fhmom9;
alter default privileges grant all on tables to hjnknsmimrlszw;
alter default privileges grant all on sequences to hjnknsmimrlszw;
